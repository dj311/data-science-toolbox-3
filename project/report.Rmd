...
The following function takes in the list of folds, and a correseponding list of predictions from a model. It will add these predictions as a column to the data frame using the indexes contained in the fold variable:
```{r}
...
TODO(DAN): model is still running, will copy over when done
