...
## K-NN for normal and non-normal added to decision trees
```{r}
connections <- copy(connection_events)
...
fold_predictions <- lapply(k_folds, function(fold) { 
    ...
    knn_model <- train(
        label~.,
        data=knn_transform(training_data),
        method="knn",
        preProcess=c("center","scale"),
    )

    predictions <- predict(knn_model, newdata=knn_transform(testing_data))
