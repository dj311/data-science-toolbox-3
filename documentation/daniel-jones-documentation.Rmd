...
```{r}
# This takes like an hour on my laptop, and requires approx 6GB
...
sort(model$variable.importance)
```

In short, the k-means clusters aren't considered important by the decision tree, and so don't make the cut!
