...
ModelResults <- function(data_transformation_function, k_folds, fold_predictions) {
    ...
    self$plot_confusion_matrix <- function(data) {
        plot_confusion_matrix(self$confusion_matrix(data))
    }
...
weighted_decision_tree_results$plot_confusion_matrix(connection_events)
