...
```{r}
ggplot(data=as.data.frame(summary_matrix), aes(x=Var1, y=Var2, fill=Freq), limits=c(0, 280790)) +
    geom_raster() +
...
# TODO
- [ ] Should probably run this on all factors (I was just lazy and didn't want to wait for it to finish).
